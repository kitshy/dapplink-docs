...
export const dataSymbol: InjectionKey<DappLinkData> = Symbol()

export interface DappLinkData<T = any> {
  /**
   * Site-level metadata
   */
  site: Ref<SiteData<T>>
...
// per-app data
export function initData(route: Route): DappLinkData {
  const site = computed(() =>
...
export function useData<T = any>(): DappLinkData<T> {
