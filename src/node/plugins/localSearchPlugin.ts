...
const debug = _debug('dapplink-docs:local-search')
...
export async function localSearchPlugin(
  ...
  return {
    ...
    config: () => ({
      optimizeDeps: {
        include: [
          'dapplink-docs > @vueuse/integrations/useFocusTrap',
          'dapplink-docs > mark.js/src/vanilla.js',
          'dapplink-docs > minisearch'
        ]
      }
    }),
