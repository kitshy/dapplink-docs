...
export async function createDappLinkPlugin(
    ...
    config() {
      const baseConfig: UserConfig = {
        ...
        optimizeDeps: {
          ...
          include: [
            'vue',
            'dapplink-docs > @vue/devtools-api',
            'dapplink-docs > @vueuse/core'
          ],
